...
/******************
 * Exercise 18 ****************** Create a Cycle interface, with implementations
 * Unicycle, Bicycle, and Tricycle. Create factories for each type of Cycle, and
 * code that uses these factories.
 ***********************************************/
interface Cycle {
	int wheels();
}
