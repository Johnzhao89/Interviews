...
/******************
 * Exercise 10 ****************** Add a Playable to Modify Music5.java, and move
 * the play() declaration from Instrument to Playable. Include Playable in the
 * implements list to add it to the derived classes. Change tune() so it takes a
