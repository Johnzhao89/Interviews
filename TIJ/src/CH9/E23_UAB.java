 ...
 * Create a class A with a method that produces a reference to a U by building
 * an anonymous inner class. Create a second class B that contains an array of
 * U. B should have one method that accepts and stores a reference to a U in the
 * array, a second method that sets a reference in the array (specified by the
 * method argument) to null, and a third method that moves through the array and
