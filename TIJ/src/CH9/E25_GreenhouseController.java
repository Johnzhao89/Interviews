...
/******************
 * Exercise 25 ****************** Inherit from GreenhouseControls in
 * GreenhouseControls.java to add Event inner classes that turn water mist
 * generators on and off. Write a new version of GreenhouseController.java to
 * use these new Event objects.
 ***********************************************/
