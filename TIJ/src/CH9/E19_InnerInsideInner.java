...
/******************
 * Exercise 19 ***************** Create a class containing an inner class that
 * itself contains an inner class. Repeat this using static inner classes. Note
 * the names of the .class files produced by the compiler.
 ***********************************************/
