...
/******************
 * Exercise 24 ***************** Add Event inner classes that turn fans on and
 * off in GreenhouseControls.java. Configure GreenhouseController.java to use
...
public class E24_GreenhouseInnerEvent {
	public static void main(String[] args) {
		...
		if (args.length == 1)
			gc.addEvent(new GreenhouseControlsWithFan.Terminate(new Integer(
					args[0])));
		gc.run();
	}
}
