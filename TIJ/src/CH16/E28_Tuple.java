...
/******************
 * Exercise 28 ***************** Modify net/mindview/util/Tuple.java to make it
 * a general-purpose class by adding hashCode(), equals(), and implementing
...
class Tuple {
		...
		public boolean equals(Object obj) {
			if (obj instanceof T2) {
				...
				return (first == null ? o.first == null : first.equals(o.first))
						&& (second == null ? o.second == null : second
								.equals(o.second));
			}
			return false;
		}
	...
	public static class T4<A, B, C, D> implements Comparable<T4<A, B, C, D>> {
		...
		public boolean equals(Object obj) {
			if (obj instanceof T4) {
				...
				return (fourth == null ? o.fourth == null : fourth
						.equals(o.fourth)) && tuple.equals(o.tuple);
			}
			return false;
		}
	...
	public static class T5<A, B, C, D, E> implements
			Comparable<T5<A, B, C, D, E>> {
		...
		public String toString() {
			return "(" + tuple.getFirst() + ", " + tuple.getSecond() + ", "
					+ tuple.getThird() + ", " + tuple.getFourth() + ", "
					+ fifth + ")";
		}
	...
	public static <A, B, C, D, E> T5<A, B, C, D, E> tuple(A a, B b, C c, D d,
			E e) {
...
public class E28_Tuple {
	public static void main(String[] args) {
		Tuple.T5<String, Integer, Boolean, Short, Long> t5_1 = Tuple.tuple("a",
				1, false, (short) 2, 3L), t5_2 = Tuple.tuple("b", 2, true,
				(short) 3, 4L);
